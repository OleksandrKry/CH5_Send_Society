...
extension AppleVisionSkeleton: Codable {
...
enum AppleVisionSkeletonExtractor {
    ...
    static func detect(inVideoFrame cgImage: CGImage, deviceOrientation: UIDeviceOrientation) throws -> AppleVisionSkeleton {
    ...
    private static func runDetection(handler: VNImageRequestHandler) throws -> AppleVisionSkeleton {
