...
///
/// 1. recording         — does depth stay correctly associated with each video frame?
/// 2. reconstruction   — does the skeleton line up with the wall in Step 4?
/// 3. tracking          — does tracking survive handheld use, or is a tripod required?
enum DebugLog {
